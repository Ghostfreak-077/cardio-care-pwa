...
const blogs = [
    ...
    },
    {
        ...
        image: 'https://www.mayoclinic.org/-/media/kcms/gbs/patient-consumer/images/2019/09/06/13/31/heart-disease-symptoms-8col.jpg'
    },
    {
        ...
        image: 'https://www.cdc.gov/heartdisease/images/prevent-heart-disease-1200x800.jpg'
    },
    {
        ...
        image: 'https://www.ahajournals.org/action/showLargeImage?doi=10.1161%2FCIRCRESAHA.119.316234'
    },
    {
        ...
        image: 'https://www.heart.org/-/media/Images/Heart-Conditions/Heart-Attack/living-with-heart-disease.jpg'
    },
    {
        ...
        image: 'https://my.clevelandclinic.org/-/scassets/images/org/health/health-rehabilitation/cardiac-rehabilitation.ashx'
    },
    {
        ...
        image: 'https://www.goredforwomen.org/-/media/images/news/2020-03/importance-of-heart-health-for-women.jpg'
    },
    {
        ...
        image: 'https://www.heartfoundation.org.au/getmedia/d962d57a-0cfb-4db1-bad2-bb59d14493ba/heart-healthy-diet-1200x800.jpg'
    },
    {
        ...
        image: 'https://img.webmd.com/dtmcms/live/webmd/consumer_assets/site_images/article_thumbnails/slideshows/heart_disease_exercise_tips_slideshow/650x350_heart_disease_exercise_tips_slideshow.jpg'
    },
    {
        ...
        image: 'https://www.heart.org/-/media/Images/News/2020-March-3/stress-and-heart-health.jpg'
    }
];
                ...
                {blogs.map((blog, index) => (
                    <div className={styles.blog} key={index}>
                        ...
                        <div className={styles.blogContent}>
                            ...
                            <p>{blog.date}</p>
                            <p>{blog.content}</p>
                            <a href={blog.read} target="_blank" rel="noopener noreferrer">Read more</a>
                        </div>
                    </div>
                ))}
            </div>
